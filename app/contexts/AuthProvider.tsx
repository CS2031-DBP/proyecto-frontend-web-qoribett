...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (tokens?.accessToken) {
        // Optionally decode token to get user, or call /me endpoint. Keep simple here.
        setUser({});
      }
      setLoading(false);
    })();
  ...
  const register = async (payload: any) => {
    ...
    // You can auto-login or show verification message. We'll attempt to auto-login if email+password present
